...
This module contains Ansible-related functionality to reduce the size of app.py.
"""
...
def parse_ansible_inventory(app, widget):
    ...
    def parse_inventory_task():
        ...
        app.ui_updater.add_text_to_output(f"Found {len(inventory_files)} inventory files\n")

        # Process each inventory file
        for inv_file in inventory_files:
            app.ui_updater.add_text_to_output(f"Parsing file: {os.path.basename(inv_file)}\n")
            ...
            app.ui_updater.add_text_to_output(f"Inventory structure:\n{formatted_data}\n\n")
