...
def save_venv_metadata(metadata_dir_path: str, venv_name: str, metadata: Dict[str, Any]) -> str:
    """
...
def load_venv_metadata(metadata_dir_path: str, venv_name: str, target_host: str) -> Optional[Dict[str, Any]]:
...
def delete_venv_metadata(metadata_dir_path: str, venv_name: str, target_host: str) -> bool:
    """
