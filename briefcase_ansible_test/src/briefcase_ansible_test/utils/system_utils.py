            ...
            if "echo ~" in cmd or "echo $HOME" in cmd:
                ...
                try:
                    ...
                    if match:
                        ...
                        stdout = (
                            b'{"failed": true, "msg": "Could not parse module path"}\n'
                        )
        ...
        def _execute_ansible_module(self, module_path):
            ...
            try:
                ...
                try:
                    ...
                    old_stdout.write(
                        "iOS_DEBUG: Ping simulation completed successfully\n"
                    )
                    old_stdout.flush()
                    ...
                    old_stdout.write(
                        f"iOS_DEBUG: Traceback: {traceback.format_exc()}\n"
                    )
                    old_stdout.flush()
                ...
                old_stdout.write(
                    f"iOS_DEBUG: Module stdout length: {len(result_json)}\n"
                )
                old_stdout.write(
                ...
                if result_json:
                    ...
                    try:
                        ...
                        raise ValueError(
                            f"Module did not return valid JSON: {result_json}"
                        )
                else:
