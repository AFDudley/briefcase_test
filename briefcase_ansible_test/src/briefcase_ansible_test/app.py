...
class briefcase_ansible_test(toga.App):
    ...
    # All file selection and dialog methods removed since files are loaded by default
    ...
    def run_playbook(self, widget):
        ...
        try:
            ...
            if not os.path.exists(playbook):
                self.status_label.text = "Error: Playbook file not found"
                return
            ...
            self.output_view.value = f"Error: {str(exception)}"
            self.status_label.text = "Error"
